...
mkValidator dat () ctx = traceIfFalse "invalid beneficiary" (signedByBeneficiary1 || signedByBeneficiary2) &&
                         ((traceIfFalse "not within deadline for beneficiary1" signedByBeneficiary1 && deadlineReached /= True) ||
                         (traceIfFalse "deadline passed for beneficiary1" signedByBeneficiary2 && deadlineReached))
  where 
    info :: TxInfo
